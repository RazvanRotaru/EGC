...
void Laborator4::Init()
{
	...
	coordX = -2.5f, coordY = 0.5f, coordZ = -1.5f;
...
void Laborator4::Update(float deltaTimeSeconds)
{
	...
	translateX += deltaTimeSeconds * 0.4;
	coordX = -2.5f + translateX;
	coordY = 0.5f + translateY;
	coordZ = -1.5f + translateZ;
	angularStepOY += deltaTimeSeconds * 0.4;
	...
	modelMatrix *= Transform3D::Translate(-coordX, -coordY, coordZ);
	modelMatrix *= Transform3D::Translate(coordX+2, coordY, coordZ);
