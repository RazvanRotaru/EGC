...
void Tema1::Init()
{
	...
	*/
	...
	Mesh* platform1 = Object2DE::CreatePlatform("platform1", corner + glm::vec3(platformXcoords[1], platformYcoords[1], 0), platformW[1], platformH[1], platformRotation[1], glm::vec3(0, 1, 0.5), platformReflect[1]);
	...
	Mesh* platform2 = Object2DE::CreatePlatform("platform2", corner + glm::vec3(platformXcoords[2], platformYcoords[2], 0), platformW[2], platformH[2], platformRotation[2], glm::vec3(1, 0, 0), platformReflect[2]);
	...
	Mesh* platform3 = Object2DE::CreatePlatform("platform3", corner + glm::vec3(platformXcoords[3], platformYcoords[3], 0), platformW[3], platformH[3], platformRotation[3], glm::vec3(0, 1, 0.5), platformReflect[3]);
	...
	Mesh* platform4 = Object2DE::CreatePlatform("platform4", corner + glm::vec3(platformXcoords[4], platformYcoords[4], 0), platformW[4], platformH[4], platformRotation[4], glm::vec3(1, 0, 0), platformReflect[4]);
	...
	Mesh* platform5 = Object2DE::CreatePlatform("platform5", corner + glm::vec3(platformXcoords[5], platformYcoords[5], 0), platformW[5], platformH[5], platformRotation[5], glm::vec3(1, 0, 0), platformReflect[5]);
	...
	Mesh* platform6 = Object2DE::CreatePlatform("platform6", corner + glm::vec3(platformXcoords[6], platformYcoords[6], 0), platformW[6], platformH[6], platformRotation[6], glm::vec3(1, 0, 0), platformReflect[6]);
	...
	Mesh* platform7 = Object2DE::CreatePlatform("platform7", corner + glm::vec3(platformXcoords[7], platformYcoords[7], 0), platformW[7], platformH[7], platformRotation[7], glm::vec3(1, 0, 0), platformReflect[7]);
	...
	Mesh* platform8 = Object2DE::CreatePlatform("platform8", corner + glm::vec3(platformXcoords[8], platformYcoords[8], 0), platformW[8], platformH[8], platformRotation[8], glm::vec3(1, 0, 1), platformReflect[8]);
	...
	*/
	...
	Mesh* triangle1 = Object2DE::CreateTriangle("triangle1", corner + glm::vec3(startX, startY, 0), l, glm::vec3(1, 1, 1), true);
	...
	*/
	...
	Mesh* asteroid1 = Object2DE::CreateAsteroid("asteroid1", corner + glm::vec3(asteroidX[asteroidNR], asteroidY[asteroidNR], 0), asteroidR[asteroidNR], glm::vec3(0.5, 0.5, 0), true);
	AddMeshToList(asteroid1);

	asteroidNR++;
	asteroidX[asteroidNR] = 500;
	asteroidY[asteroidNR] = 50;
	asteroidR[asteroidNR] = 150;
	Mesh* asteroid2 = Object2DE::CreateAsteroid("asteroid2", corner + glm::vec3(asteroidX[asteroidNR], asteroidY[asteroidNR], 0), asteroidR[asteroidNR], glm::vec3(0.5, 0.5, 0), true);
...
void Tema1::Update(float deltaTimeSeconds)
{
	...
	if (!GameOver) {
		...
		if (glm::distance(glm::vec3(asteroidMove[1], 0), glm::vec3(0, 0, 0)) > 200) {
			asteroidLimit[1] = true;
		}
		if (glm::distance(glm::vec3(asteroidMove[1], 0), glm::vec3(0, 0, 0)) < 100) {
			asteroidLimit[1] = false;
		}
		...
		if (asteroidScale[2] > 1.2) {
			asteroidLimit[2] = true;
		}
		if (asteroidScale[2] < 0.6) {
			asteroidLimit[2] = false;
		}

		if (asteroidLimit[2]) {
			asteroidScale[2] -= deltaTimeSeconds * 0.5;
		}
		else {
			asteroidScale[2] += deltaTimeSeconds * 0.5;
		}
		...
		asteroidAngl[2] += deltaTimeSeconds;
	...
	for (int i = 1; i <= asteroidNR; i++) {
		...
		if (asteroidScale[i])
			modelMatrix *= Transform2D::Scale(asteroidScale[i], asteroidScale[i]);
		modelMatrix *= Transform2D::Translate(-asteroidX[i], -asteroidY[i]);
