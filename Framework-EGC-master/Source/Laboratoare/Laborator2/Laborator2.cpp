...
void Laborator2::Init()
{
	...
	// Create a mesh box using custom data
	{
		...
		vector<unsigned short> indices =
		{
			...
			2, 1, 3,
			0, 3, 1,// TODO: Complete indices data
		};
		...
		Mesh *jmen = CreateMesh("cube2", vertices2, indices2);
	}
}
...
void Laborator2::Update(float deltaTimeSeconds)
{
	...
	// TODO: Enable face culling
		...
		RenderMesh(meshes["cube3"], shaders["VertexColor"], glm::vec3(0, 0, 0), glm::vec3(1));
		RenderMesh(meshes["cube2"], shaders["VertexColor"], glm::vec3(0, 3, 0), glm::vec3(1));
