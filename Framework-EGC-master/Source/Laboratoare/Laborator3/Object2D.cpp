...
Mesh* Object2D::CreateTriangle(std::string name, glm::vec3 Centre, float l, glm::vec3 color, bool fill)
{
...
Mesh* Object2D::CreatePlatform(std::string name, glm::vec3 leftBottomCorner, float l,float h, float rot, glm::vec3 color, bool reflect)
{
	glm::vec3 corner = leftBottomCorner;
...
Mesh* Object2D::CreateAsteroid(std::string name, glm::vec3 Centre, float r, glm::vec3 color, bool fill)
{
